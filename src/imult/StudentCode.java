...
//
// ------------------------------------------------------------------
    BigIntMul.mulTest(new Unsigned(50), new Unsigned(10))
    BigIntMul.mulTest(new Unsigned(50), new Unsigned(100))
    BigIntMul.mulTest(new Unsigned(50), new Unsigned(500))
    BigIntMul.mulTest(new Unsigned(50), new Unsigned(1000))
